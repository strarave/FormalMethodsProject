...
\begin{document}
	...
	\section{Result Discussion}
			As we can see from the previous section, starting from an initial configuration given by parameters such as at point \ref{sub:sim1} leads to a failure, or, in other words, to a high probability of loosing a task.\\In order to avoid this, few parameter changes are made:
			\begin{itemize}
